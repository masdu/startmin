<?php
	...
	$body = new Template("wishlistsTable.html"); 		// sottotemplate per la home

	$main->setContent("nickname", $_SESSION['nickname']);

    $query = "SELECT wishlists.id, wishlists.email as user, books.title as title, wishlists.price FROM wishlists INNER JOIN books ON books.isbn = wishlists.book";
